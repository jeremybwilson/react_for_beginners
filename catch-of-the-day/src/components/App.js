...
class App extends React.Component {
  ...
  componentDidMount(){
    // console.log('MOUNTED');
    // this.ref = base.syncState(`${this.props.match.params.storeId}`);  // this is too long...
    // lets see how we can destructure
  ...
  updateFish = (key, updatedFish) => {
    ...
    // 1. Take a copy of the crrent state
    const fishes = { ...this.state.fishes };
    // 2. Update that state
  ...
  addToOrder = (key) => {
    ...
    // 3. call set state to updated our object
    this.setState({ order });
  }
